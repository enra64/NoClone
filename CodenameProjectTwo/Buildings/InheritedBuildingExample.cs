...
namespace CodenameProjectTwo.Buildings {
    class InheritedBuildingExample : AbstractBuilding{
        ...
        public InheritedBuildingExample(int _type, byte _faction, int _ID, Vector2f _position, float _health) : base(_type, _faction, _ID, _position, _health) {
            Name = "test";
        }
